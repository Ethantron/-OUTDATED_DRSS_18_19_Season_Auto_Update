...
@Disabled
@Autonomous(name = "Anglekeep", group = "Auto")
public class Anglekeep extends LinearOpMode {
    ...
    double RangeDiv = Range / 2; //Evenly splits the range along 0
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if (angles.firstAngle > -RangeDiv && angles.firstAngle < RangeDiv) { //Stops Robot if centered
            ...
            if (angles.firstAngle < 1 && centered == 0) { //adjust robots by turning right
            ...
            if (angles.firstAngle > 1 && centered == 0) { //adjust robots by turning left
                motorFrontRight.setPower(Power);
                motorFrontLeft.setPower(-Power);
                motorBackRight.setPower(Power);
                motorBackLeft.setPower(-Power);
